...
public class MyRaffleListAdapter extends RecyclerView.Adapter<MyRaffleListAdapter.MyViewHolder>{

    private Context context;
    private List<String> reportWorkList;

    public MyRaffleListAdapter(Context context, List<String> reportWorkList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_my_raffle, parent, false);
