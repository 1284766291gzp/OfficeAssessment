...
public class ReportWorkLookListAdapter extends RecyclerView.Adapter<ReportWorkLookListAdapter.MyViewHolder>{

    private Context context;
    private List<String> reportWorkList;

    public ReportWorkLookListAdapter(Context context, List<String> reportWorkList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_report_work_look, parent, false);
