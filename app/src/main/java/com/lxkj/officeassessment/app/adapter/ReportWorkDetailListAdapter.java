...
public class ReportWorkDetailListAdapter extends RecyclerView.Adapter<ReportWorkDetailListAdapter.MyViewHolder>{

    private Context context;
    private List<String> reportWorkList;

    public ReportWorkDetailListAdapter(Context context, List<String> reportWorkList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_report_work_detail, parent, false);
