...
public class RegularJobListAdapter extends RecyclerView.Adapter<RegularJobListAdapter.MyViewHolder>{

    private Context context;
    private List<String> reportWorkList;

    public RegularJobListAdapter(Context context, List<String> reportWorkList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_regular_job, parent, false);
