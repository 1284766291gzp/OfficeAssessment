...
public class GetListListAdapter extends RecyclerView.Adapter<GetListListAdapter.MyViewHolder>{

    private Context context;
    private List<String> reportWorkList;

    public GetListListAdapter(Context context, List<String> reportWorkList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_get_list, parent, false);
